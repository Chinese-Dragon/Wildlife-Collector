...
public class UTM {
    ...
    public UTM(double latitude, double longitude) {
        calcUTM(latitude, longitude);
    }

    private void calcUTM(double latitude, double longitude) {
